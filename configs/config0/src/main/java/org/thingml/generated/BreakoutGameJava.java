...
Transition h274298188 = new Transition();
h274298188.from(state_BreakoutGame_SC_INIT).to(state_BreakoutGame_SC_LAUNCH);
h274298188.event(displayReadyType);
h274298188.port(display_port);
h274298188.action((Event e)->{
...
Handler h1427247001 = new Handler();
h1427247001.from(state_BreakoutGame_SC_LAUNCH);
h1427247001.event(timer_timeoutType);
h1427247001.guard((Event e)->{
...
h1427247001.port(clock_port);
h1427247001.action((Event e)->{
final Timer_timeoutMessageType.Timer_timeoutMessage timer_timeout = (Timer_timeoutMessageType.Timer_timeoutMessage) e;
sendTimer_start_via_clock((int) (0), (int) (getBreakoutGame_period_var()));
drawPad();
...
Transition h1868809295 = new Transition();
h1868809295.from(state_BreakoutGame_SC_LAUNCH).to(state_BreakoutGame_SC_PLAY);
h1868809295.event(timer_timeoutType);
h1868809295.guard((Event e)->{
final Timer_timeoutMessageType.Timer_timeoutMessage timer_timeout = (Timer_timeoutMessageType.Timer_timeoutMessage) e;
return timer_timeout.id == 0 && getBreakoutGame_SC_LAUNCH_countdown_var() == 0;
});

h1868809295.port(clock_port);
h1868809295.action((Event e)->{
final Timer_timeoutMessageType.Timer_timeoutMessage timer_timeout = (Timer_timeoutMessageType.Timer_timeoutMessage) e;
drawCountDown((int) (0));
resetBall();
sendUpdate_via_display();
...
Handler h358420513 = new Handler();
h358420513.from(state_BreakoutGame_SC_PLAY);
h358420513.event(timer_timeoutType);
h358420513.guard((Event e)->{
final Timer_timeoutMessageType.Timer_timeoutMessage timer_timeout = (Timer_timeoutMessageType.Timer_timeoutMessage) e;
return timer_timeout.id == 0;
});

h358420513.port(clock_port);
h358420513.action((Event e)->{
final Timer_timeoutMessageType.Timer_timeoutMessage timer_timeout = (Timer_timeoutMessageType.Timer_timeoutMessage) e;
...
Transition h13643661 = new Transition();
h13643661.from(state_BreakoutGame_SC_PLAY).to(state_BreakoutGame_SC_LOSTBALL);
h13643661.event(lostBallType);
h13643661.port(game_port);
h13643661.action((Event e)->{
sendTimer_cancel_via_clock((int) (0));
});

Transition h1173504361 = new Transition();
h1173504361.from(state_BreakoutGame_SC_PLAY).to(state_BreakoutGame_SC_NEXTLEVEL);
h1173504361.event(nextLevelType);
h1173504361.port(game_port);
h1173504361.action((Event e)->{
sendTimer_cancel_via_clock((int) (0));
});

Transition h775574071 = new Transition();
h775574071.from(state_BreakoutGame_SC_LOSTBALL).to(state_BreakoutGame_SC_LAUNCH);
h775574071.event(timer_timeoutType);
h775574071.guard((Event e)->{
final Timer_timeoutMessageType.Timer_timeoutMessage timer_timeout = (Timer_timeoutMessageType.Timer_timeoutMessage) e;
return timer_timeout.id == 0 && getBreakoutGame_lives_var() > 0;
});

h775574071.port(clock_port);
Transition h1248435962 = new Transition();
h1248435962.from(state_BreakoutGame_SC_LOSTBALL).to(state_BreakoutGame_SC_GAMEOVER);
h1248435962.event(timer_timeoutType);
h1248435962.guard((Event e)->{
final Timer_timeoutMessageType.Timer_timeoutMessage timer_timeout = (Timer_timeoutMessageType.Timer_timeoutMessage) e;
return timer_timeout.id == 0 && getBreakoutGame_lives_var() == 0;
});

h1248435962.port(clock_port);
Transition h1767532961 = new Transition();
h1767532961.from(state_BreakoutGame_SC_NEXTLEVEL).to(state_BreakoutGame_SC_LAUNCH);
h1767532961.event(timer_timeoutType);
h1767532961.guard((Event e)->{
final Timer_timeoutMessageType.Timer_timeoutMessage timer_timeout = (Timer_timeoutMessageType.Timer_timeoutMessage) e;
return timer_timeout.id == 0;
});

h1767532961.port(clock_port);
final CompositeState state_BreakoutGame_SC = new CompositeState("SC");
state_BreakoutGame_SC.onEntry(()->{
});
Handler h1731967318 = new Handler();
h1731967318.from(state_BreakoutGame_SC);
h1731967318.event(positionType);
h1731967318.port(controller_port);
h1731967318.action((Event e)->{
