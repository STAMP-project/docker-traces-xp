...
Transition h142103421 = new Transition();
h142103421.from(state_BasicIAController_SC_Following).to(state_BasicIAController_SC_Following);
h142103421.event(updateIAType);
h142103421.port(game_port);
h142103421.action((Event e)->{
