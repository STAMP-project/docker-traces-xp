...
Handler h453007883 = new Handler();
h453007883.from(state_TimerJava_SoftTimer_default);
h453007883.event(timer_startType);
h453007883.guard((Event e)->{
