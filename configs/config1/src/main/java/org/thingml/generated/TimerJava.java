...
Handler h1907808127 = new Handler();
h1907808127.from(state_TimerJava_SoftTimer_default);
h1907808127.event(timer_startType);
h1907808127.guard((Event e)->{
...
h1907808127.port(timer_port);
h1907808127.action((Event e)->{
final Timer_startMessageType.Timer_startMessage timer_start = (Timer_startMessageType.Timer_startMessage) e;
